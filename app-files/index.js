...
(function () {
  ...
  const bgmenuToggleElement = document.querySelector("#bgmenu");
  ...
  // Set handler for scene switch.(Untuk Perpindahan Scene)
  ...
  function toggleAutorotate() {
    if (autorotateToggleElement.classList.contains("enabled")) {
      autorotateToggleElement.classList.remove("disabled");
      stopAutorotate();
    } else {
